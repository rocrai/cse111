...
def main():
    ...
    birthdays = lambda students_list: students_list[2]
    given_name = lambda students_list: students_list[0]

    sorted_list = sorted(students_list, key=birthdays)
    sorted_name = sorted(students_list, key=given_name)
