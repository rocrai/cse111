...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    totalmass_list = []
    totalmass = 0
    for amass in symbol_quantity_list:
        a_mass = periodic_table_dict[amass[SYMBOL_INDEX]]
        a_mass = a_mass[1]
        number = amass[1]
        totalmass_append = a_mass * number
        totalmass_list.append(totalmass_append)
    for mass in range(0, len(totalmass_list)):
        totalmass = totalmass + totalmass_list[mass]
    return totalmass
